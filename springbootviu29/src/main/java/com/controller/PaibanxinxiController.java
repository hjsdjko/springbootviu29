...
public class PaibanxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,PaibanxinxiEntity paibanxinxi,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date paibanriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date paibanriqiend,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("chuangkoufuzeren")) {
			paibanxinxi.setChuangkoubianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("chuangkouyuangong")) {
			paibanxinxi.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<PaibanxinxiEntity> ew = new EntityWrapper<PaibanxinxiEntity>();
                if(paibanriqistart!=null) ew.ge("paibanriqi", paibanriqistart);
                if(paibanriqiend!=null) ew.le("paibanriqi", paibanriqiend);
